...
export const Card = ({ name, copy, title, profile, person, mode }) => (
  ...
  <Box width={{ md: "520px", sm: "400px", xs: "184px" }} borderRadius={5}  boxShadow={mode==="dark"?"1px 5px 37px gray":"1px 5px 30px gray"} m={{ md: 3, sm: 1.5,xs:1 }} p={3} textAlign={"center"} sx={{ backgroundColor: mode === "light" ? "white" : "black" }}>
